...
/**
 * Filters the given {@link Issue} list for the given <code>userName</code> and the resulting list is transformed to a list of {@link GetIssueResultItem}.
 */
public class IssueListToGetIssueResultItemListTransformer {
    ...
    public IssueListToGetIssueResultItemListTransformer(String userName, List<Issue> issues) {
        this.issues = issues;
        this.userName = userName;
    }

    public List<GetIssueResultItem> execute() {
